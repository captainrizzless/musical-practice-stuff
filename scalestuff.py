...
major_scale_contents = namedtuple('major_scale_stuff', ('First_Degree', 'Second_Degree', 'Third_Degree',
                                                        'Fourth_Degree', 'Fifth_Degree', 'Sixth_Degree',
                                                        'Seventh_Degree'))
...
major_penta_scale_contents = namedtuple('major_penta_scale_stuff', ('First_Degree', 'Second_Degree',
                                                                    'Third_Degree', 'Fifth_Degree',
                                                                    'Sixth_Degree'))
...
minor_scale_contents = namedtuple('minor_scale_stuff', ('First_Degree', 'Second_Degree', 'Third_Degree',
                                                        'Fourth_Degree', 'Fifth_Degree', 'Sixth_Degree',
                                                        'Seventh_Degree'))
...
melminor_scale_contents = namedtuple('melminor_scale_stuff', ('First_Degree', 'Second_Degree', 'Third_Degree',
                                                              'Fourth_Degree', 'Fifth_Degree', 'Sixth_Degree',
                                                              'Seventh_Degree'))
...
harminor_scale_contents = namedtuple('harminor_scale_stuff', ('First_Degree', 'Second_Degree', 'Third_Degree',
                                                              'Fourth_Degree', 'Fifth_Degree', 'Sixth_Degree',
                                                              'Seventh_Degree'))
...
minor_penta_scale_contents = namedtuple('minor_penta_scale_stuff', ('First_Degree', 'Third_Degree',
                                                                    'Fourth_Degree', 'Fifth_Degree',
                                                                    'Seventh_Degree'))
minor_penta_scale_stuff = minor_penta_scale_contents(3, 2, 2, 3, 2)

print('The numbers represent semitones\n')
print(major_scale_stuff)
print(major_penta_scale_stuff)
print(minor_scale_stuff)
print(melminor_scale_stuff)
print(harminor_scale_stuff)
print(minor_penta_scale_stuff)

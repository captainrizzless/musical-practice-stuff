...
print(ionian_mode_stuff)
print(dorian_mode_stuff)
print(phrygian_mode_stuff)
print(lydian_mode_stuff)
print(mixolydian_mode_stuff)
print(aeolian_mode_stuff)
print(locrian_mode_stuff)
